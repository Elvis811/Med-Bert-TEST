...
def main_function(input_files, bert_config_file, output_dir, do_train=False, do_eval=False, use_tpu=False, tpu_name=None, tpu_zone=None, gcp_project=None, master=None, train_batch_size=32, eval_batch_size=8, learning_rate=5e-5, num_train_steps=100000, num_warmup_steps=10000, save_checkpoints_steps=10000, iterations_per_loop=1000, max_eval_steps=100, num_tpu_cores=8):
    ...
    input_files = [file_io.get_matching_files(input_file) for input_file in input_files]
...
if __name__ == "__main__":
    main_function(input_files="input.tfrecord", bert_config_file="bert_config.json", output_dir="output")
